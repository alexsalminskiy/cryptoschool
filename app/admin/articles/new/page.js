            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap items-center gap-1 p-2 bg-slate-800 rounded-lg border border-slate-700">
                ...
                <div className="relative">
                  <Button type="button" variant="ghost" size="sm" onClick={() => { saveSelection(); setShowSizePicker(!showSizePicker); setShowColorPicker(false) }} className="h-8 w-8 p-0" title="Размер текста">
                ...
                {/* Цвет текста */}
                <div className="relative">
                  <Button type="button" variant="ghost" size="sm" onClick={() => { saveSelection(); setShowColorPicker(!showColorPicker); setShowSizePicker(false) }} className="h-8 w-8 p-0" title="Цвет текста">
